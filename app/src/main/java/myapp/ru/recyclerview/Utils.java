...
public class Utils {
    ...
    public static final String PIZZA_3_TITLE = "Caramelised onion";
    ...
    public static final String PIZZA_4_RECIPE = "1) Mix the flours and yeast with a pinch of salt in a food processor fitted with a dough blade. Pour in the water and mix to a soft dough, then work for 1 min. Remove the dough and roll out on a lightly floured surface to a round about 30cm across. Lift onto an oiled baking sheet.\n" +
            "\n" +
    ...
    public static final String PIZZA_5_RECIPE = "1) Heat oven to 220C/fan 200C/gas 7. Place the pepper, courgette and red onion on a large non-stick baking tray and drizzle with 1 tsp olive oil. Season well and toss to combine. Roast in the oven for 20 mins until soft and beginning to brown. Set aside.\n" +
            "\n" +
    ...
    public static final String PIZZA_7_RECIPE = "1) Heat oven to 180C/160C fan/gas 4. Toss the red onion with the red wine vinegar and a good pinch of salt and set aside (the vinegar will soften the onion slightly, which is a blessing as no one wants completely raw onion on pizza).\n" +
            "\n" +
    ...
    public static final String PIZZA_8_RECIPE = "1) In a bowl, mix flour, semolina, salt and yeast. Make a dip in the middle, pour in oil, water, then stir and squeeze everything together (hands are easiest for this). The dough should feel very sticky (pic 1). When it is well mixed, cover and leave for 15 mins.\n" +
            "\n" +
